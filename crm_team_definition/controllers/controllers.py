...
#     @http.route('/crm_team_definition/crm_team_definition/',
#     auth='public')
#     def index(self, **kw):
#         return "Hello, world"
...
#             'objects': http.request.env['crm_team_definition.
#             crm_team_definition'].search([]),
#         })

#     @http.route('/crm_team_definition/crm_team_definition/objects/
#     <model("crm_team_definition.crm_team_definition"):obj>/',
#     auth='public')
