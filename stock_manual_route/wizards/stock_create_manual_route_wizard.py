...
class StockCreateManualRouteWizard(models.TransientModel):
    ...
    @api.model
    def _prepare_picking(self, picking, picking_type, src_location, dest_location, scheduled_date):
        self.ensure_one()
        return {
    ...
    def create_pickings(self):
        ...
        transit_location = self.env.user.company_id.internal_transit_location_id
    ...
    def create_moves(self, src_picking, out_picking, in_picking):
        ...
        for move in src_picking.move_lines:
            ...
            out_move = sm_obj.create(self._prepare_stock_move(move, out_picking))
            # Create the input move
            in_move = sm_obj.create(self._prepare_stock_move(move, in_picking))
            # Link Moves
