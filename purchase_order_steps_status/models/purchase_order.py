...
class PurchaseOrder(models.Model):
    ...
    current_step_health = fields.Char(compute="_compute_current_step_health", default="N/A")
    current_step_percentage = fields.Float(compute="_compute_current_step_percentage", default=0.0)
